...
const topPaidEmployees = [
  { name: "Cody Fisher", company: "Louis Vuitton", salary: "$12,500", date: "1 Jun 2022" },
  { name: "Esther Howard", company: "Starbucks", salary: "$11,800", date: "1 May 2022" },
  { name: "Wade Warren", company: "Louis Vuitton", salary: "$10,750", date: "1 Apr 2022" },
  { name: "Brooklyn Simmons", company: "Sony", salary: "$9,900", date: "1 Mar 2022" },
  { name: "Ralph Edwards", company: "IBM", salary: "$9,500", date: "1 Feb 2022" },
  { name: "Dianne Russell", company: "Disney", salary: "$9,200", date: "1 Jan 2022" },
  { name: "Dianne Russell", company: "Disney", salary: "$9,200", date: "1 Jan 2022" },
];
        ...
        {topPaidEmployees.map((employee, index) => (
          <li key={index} className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-3">
              <DicebearAvatar seed={employee.name} size={60} className="w-10 h-10  rounded-full" />
              <div>
